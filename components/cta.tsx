      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="relative px-8 py-12 md:py-20 rounded-[3rem] overflow-hidden">
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="h2 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4 mb-8 mt-8">Tá afim de trocar uma ideia?</h2>
            <div className="max-w-xs mx-auto mb-8 sm:max-w-none sm:inline-flex sm:justify-center space-y-4 sm:space-y-0 sm:space-x-4">

              {/* Linkedin */}
              <a href="https://www.linkedin.com/in/miguel-rodrigues-46073b1b8">
                <svg
              ...
              {/* Gmail */}
              <a href="mailto:miguellrrodrigues@gmail.com">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-10 w-10"
                  fill="currentColor"
