          ...
          <div className="sm:col-span-12 lg:col-span-4 order-1 lg:order-none">
            <div className="h-full flex flex-col sm:flex-row lg:flex-col justify-between">
              <div className="mb-4 sm:mb-0">
                ...
                <div className="text-sm text-slate-300">© Miguel Rodrigues <span className="text-slate-500">-</span> 2023.</div>
              </div>
              { /* Social links */}
              {/* <ul className="flex">
                <li>
                ...
                <li className="ml-2">
                  <a className="flex justify-center items-center text-blue-500 hover:text-blue-400 transition duration-150 ease-in-out" href="#0" aria-label="Dev.to">
                ...
                <li className="ml-2">
                  <a className="flex justify-center items-center text-blue-500 hover:text-blue-400 transition duration-150 ease-in-out" href="#0" aria-label="Github">
                    <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
